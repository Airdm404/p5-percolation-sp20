...
public class PercolationBFS extends PercolationDFSFast{
     ...
     * @param column is the column of cell
     */
    protected void dfs(int row, int  col){
        ...
        //Check if cell is Full or blocked
        ...
        //Check the four neighbors of cell, and if they are open and not full then mark them as FULL and add to queue
        while (queue.size() != 0){
